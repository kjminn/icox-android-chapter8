...
//            leaderboard.loadCurrentPlayerLeaderboardScore(getString(R.string.leaderboard_id),  TIME_SPAN_DAILY, COLLECTION_PUBLIC ).addOnSuccessListener {
//                Log.d("RESULT", "test")
//                var text = scoreLabel.text.toString()
//                text += "\n 순위: ${it.get()?.displayRank}, 점수: ${it.get()?.displayScore}"
